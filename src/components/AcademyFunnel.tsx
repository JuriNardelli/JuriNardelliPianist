      ...
      <section className="relative z-10 flex min-h-screen items-center justify-center px-6 pt-20">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <motion.button
            ...
            onClick={nextStep}
            className="mt-10 group relative inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-amber-500 to-amber-600 px-8 py-4 text-sm font-semibold text-black overflow-hidden"
            ...
            <div className="mx-auto max-w-3xl px-6">
              ...
              >
                <p className="text-xl text-white mb-8">
                  If you nodded yes, <span className="text-amber-400">keep going.</span>
                </p>
                <motion.button
                  onClick={nextStep}
          ...
          >
            <div className="mx-auto max-w-4xl px-6 text-center">
              ...
              <motion.button
                ...
                onClick={nextStep}
                className="mt-10 inline-flex items-center gap-2 text-amber-500 hover:text-amber-400 transition-colors"
                whileHover={{ y: 5 }}
              >
            ...
            <div className="mx-auto max-w-5xl px-6">
              <div className="grid items-center gap-12 lg:grid-cols-2">
                ...
                <div>
                  ...
                  <motion.button
                    onClick={nextStep}
                    className="mt-8 inline-flex items-center gap-2 text-amber-500 hover:text-amber-400 transition-colors"
                    whileHover={{ x: 5 }}
                  >
          ...
          >
            <div className="mx-auto max-w-5xl px-6">
              ...
              >
                <motion.button
                  onClick={nextStep}
                  className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-amber-500 to-amber-600 px-8 py-4 text-sm font-semibold text-black"
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.98 }}
                >
