        ...
        {selectedPhoto && (
          ...
          >
            ...
            <button
              ref={closeButtonRef}
              onClick={closeModal}
              className="absolute top-6 right-6 rounded-full bg-white/10 p-3 text-white transition-colors hover:bg-white/20 focus:outline-none focus:ring-2 focus:ring-white/30"
